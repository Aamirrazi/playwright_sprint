...
test("tc-006 ,E2E Transaction Logging Sync", async ({
  ...
  await test.step("Verify UI Overview updated", async () => {
    ...
    expect(uiToAfter).toBeCloseTo(uiToBefore + TRANSFER_DATA.e2eTransferNum, 2);
